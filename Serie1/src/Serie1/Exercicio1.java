...
public class Exercicio1 {
	 ...
	 * array com duas posiçoes. Caso nao existam dois elementos	cuja soma seja s, deve
	 * ser retornado null.	Serao penalizadas as soluçoes com custo superior a O(n),
	 * onde n é a dimensao de v.
	*/
	...
	public static int retirarMaiores (int[] a, int value){
		...
		while(l<=r){
			meio = l+(r-l)/2;
			//se o valor do meio foi igual ao value retorna a ultima posiçao valida
			if(a[meio] == value) 
				return meio-1;
